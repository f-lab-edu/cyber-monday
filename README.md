...
| - | - | 소지한 적립금 조회 | 13 |
| - | - | 소지한 쿠폰 조회 | 19 |
| - | 회원 탈퇴 | 아이디 삭제(soft delete) | 40 |
| - | 주문 | 적립금 사용 | 21 |
| - | - | 적립금 반환 | 33 |
| 프로모션 | 프로모션 목록 | 프로모션 목록 조회 | 4 |
| - | 프로모션 상세 | 프로모션 정보 조회 | 34 |
| - | - | 프로모션 기간 검증 | 35 |
| 상품 | 상품 조회 | 상품 정보 조회 | 9 |
| 주문 | 주문 내역 | 주문 완료 데이터 추가 | 15 |
| - | - | 주문내역 조회 | 20 |
| - | 주문 취소 | 주문 취소 | 30 |
| 쿠폰 | 주문 | 소지한 쿠폰 사용 | 25 |
| - | 쿠폰 조회 | 프로모션 쿠폰 조회 | 34 |
...
| - | - | 프로모션 쿠폰 다운로드 | 39 |
| - | 주문 | 사용가능 쿠폰 조회 | 22 |
| 장바구니 | 상품 추가 | 장바구니에 상품 추가 | 27 |
| - | 장바구니 조회 | 장바구니 상품 조회 | 26 |
| - | 상품 정보 변경 | 장바구니 상품 수량 변경 | 29 |
| - | 상품 삭제 | 장바구니 상품 삭제 | 28 |
| 결제 | 결제 처리 | 결제 처리 | 14 |
| - | 취소 | 결제 취소 | 31 |
